...
Gem::Specification.new do |s|
  ...
  s.add_dependency "actionmailer", ">= 3.2.6", "< 6.1"
  s.add_dependency "actionpack", ">= 3.2.6", "< 6.1"
  s.add_dependency "devise", ">= 3.2", "< 6.1"

  s.add_development_dependency "rspec", "~> 3.0"
  s.add_development_dependency "inch", "~> 0.4"
  s.add_development_dependency "activerecord", ">= 3.2.6", "< 6.1"
